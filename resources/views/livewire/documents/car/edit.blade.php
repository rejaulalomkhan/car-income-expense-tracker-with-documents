            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6">
                    <div class="flex justify-between items-center mb-4">
                        <h2 class="text-xl font-semibold text-gray-900">Edit Car Document</h2>
                    ...
                    <form wire:submit="update" class="space-y-4">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-1 gap-4">
                            <div class="mb-4 flex items-center justify-between">
                                ...
                                hover:file:bg-indigo-100">
                                    @error('document_image') <span class="text-red-500 text-xs mt-1">{{ $message
                                        }}</span>
                                    @enderror
                                ...
                                <div class=" mt-2 flex items-center bg-slate-200 p-2 rounded-md">
                        ...
                        <div class="flex justify-end pt-2">
                            ...
                            <a href="{{ route('documents.car.index') }}"
                                class="ml-3 inline-flex items-center px-3 py-1.5 bg-gray-200 border border-transparent rounded-md font-medium text-xs text-gray-800 uppercase tracking-widest hover:bg-gray-300 active:bg-gray-400 focus:outline-none focus:ring ring-gray-300 disabled:opacity-25 transition">
                                Cancel
                            </a>
                            <button type="submit"
