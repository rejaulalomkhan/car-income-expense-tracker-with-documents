<div>
    ...
    <div class="mb-6 bg-white p-4 rounded-lg shadow">
        <div class="flex justify-between items-center mb-4">
            ...
            <button wire:click="exportFullReport"
    ...
    <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-4 bg-indigo-600 flex justify-between items-center">
                ...
                <button wire:click="exportIncome"
                    class="inline-flex items-center px-3 py-1 bg-white border border-transparent rounded-md font-semibold text-xs text-indigo-600 uppercase tracking-widest hover:bg-indigo-50">
                ...
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="bg-gray-50">
                            ...
                            @endforeach
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $totalIncome
                                }}</td>
                            <td></td>
                        </tr>
                    </tbody>
        ...
        <div class="bg-white rounded-lg shadow overflow-hidden">
            <div class="p-4 bg-red-600 flex justify-between items-center">
                ...
                <button wire:click="exportExpense"
                    class="inline-flex items-center px-3 py-1 bg-white border border-transparent rounded-md font-semibold text-xs text-red-600 uppercase tracking-widest hover:bg-red-50">
                    <i class="fas fa-download mr-2"></i> Export
                </button>
            </div>
            <div class="overflow-x-auto">
                <table class="min-w-full divide-y divide-gray-200">
                    ...
                    <tbody class="bg-white divide-y divide-gray-200">
                        ...
                        <tr class="bg-gray-50">
                            ...
                            @endforeach
                            <td class="px-6 py-4 whitespace-nowrap text-sm font-semibold text-gray-900">{{ $totalExpense
                                }}</td>
                            <td></td>
                        </tr>
                    </tbody>
